...
public final class SwerveSettings {
    ...
    public static final class SwerveDriveTrain {
        ...
        public static final double wheelBase = Units.inchesToMeters(20.5); //27.75
        ...
        public static final int drivePeakCurrentLimit = 30; // 35
        ...
        public static final class Mod0 {
            ...
            public static final double angleOffset = 51.855;
        ...
        public static final class Mod1 {
            ...
            public static final double angleOffset = 87.011;
            public static final SwerveModuleConstants constants = 
                new SwerveModuleConstants(driveMotorID, angleMotorID, canCoderID, angleOffset);
        }
        ...
        public static final class Mod2 {
            ...
            public static final double angleOffset = 102.917;
            public static final SwerveModuleConstants constants = 
                new SwerveModuleConstants(driveMotorID, angleMotorID, canCoderID, angleOffset);
        }
        ...
        public static final class Mod3 {
            ...
            public static final double angleOffset = 257.343;
            public static final SwerveModuleConstants constants = 
                new SwerveModuleConstants(driveMotorID, angleMotorID, canCoderID, angleOffset);
        }
    }
    ...
    public static final class AutoConstants {
      ...
      public static enum PathList {
        OutDS1("Out - DS 1", new PathConstraints(0.75, 1), 0),      
        OutDS2("Out - DS 2", new PathConstraints(0.75, 1), 0),
        OutDS3("Out - DS 3", new PathConstraints(0.75, 1), 0),
        OutAndDockDS2("Out and Dock -  DS 2", new PathConstraints(0.75, 1), 0),
        TestPath("Test Path - Dock", new PathConstraints(0.75, 1), 0),
        OutLeftDS2("Out the Left - DS 2", new PathConstraints(0.75, 1), 0);
