...
public class SwerveModule {
    ...
    public void setDesiredState(SwerveModuleState desiredState, boolean isOpenLoop, double powerPercentage) {
        ...
        double angle = ((Math.abs(desiredState.speedMetersPerSecond) <= (SwerveSettings.driver.maxSpeed() * 0.011)) ? lastAngle : desiredState.angle.getDegrees()) * powerPercentage; //Prevent rotating module if speed is less then 1%. Prevents Jittering.
